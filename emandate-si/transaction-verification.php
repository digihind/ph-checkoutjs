...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $transactionVerificationData = json_decode($res_result, true);

    echo '<div class="alert alert-info">
        <strong>Merchant Transaction Identifier:</strong> ' . htmlspecialchars($transactionVerificationData['merchantTransactionIdentifier']) . '
    </div>';
}
?>
<html>
