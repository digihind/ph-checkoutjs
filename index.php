    ...
    ?>
        ...
        <table class="table" border = "1" cellpadding="2" cellspacing="0" style="width: 50%;text-align: center;">
          <tr>
            ...
            <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/verify/offline_verification.php"; ?>' target="_blank">GO TO OFFLINE-VERIFICATION</a></td>
            <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/verify/reconciliation.php"; ?>' target="_blank">GO TO RECONCILIATION</a></td>
            <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/verify/refund.php"; ?>' target="_blank">GO TO REFUND</a></td>
            <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/verify/emandate-si/mandate-verification.php"; ?>' target="_blank">GO TO MANDATE VERIFICATION</a></td>
            <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/verify/emandate-si/transaction-scheduling.php"; ?>' target="_blank">GO TO TRANSACTION SCHEDULING</a></td>
            <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/verify/emandate-si/transaction-verification.php"; ?>' target="_blank">GO TO TRANSACTION VERIFICATION</a></td>
            <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/verify/emandate-si/mandate-deactivation.php"; ?>' target="_blank">GO TO MANDATE DEACTIVATION</a></td>
            <td><a href='<?php echo $host."://".$_SERVER["HTTP_HOST"]."/verify/emandate-si/stop-payment.php"; ?>' target="_blank">GO TO STOP PAYMENT</a></td>
          </tr>
        </table><br>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $host."://".$_SERVER["HTTP_HOST"].'/verify/assets/css/bootstrap.min.css';?>">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js" type="text/javascript"></script>
    <script src="<?php echo $host."://".$_SERVER["HTTP_HOST"].'/verify/assets/js/bootstrap.min.js';?>"></script>
